...
layui.define(function (e) {
    ...
    u.prototype.type = function () {
        ...
        return ['<div class="layui-box layui-laypage layui-laypage-' + (a.theme ? /^#/.test(a.theme) ? "molv" : a.theme : "default") + '" id="layui-laypage-' + a.login + '">', function () {
            var e = [];
        ...
        var s = a[t]("layui-laypage-" + i.login);
    ...
    var s = {
        render: function (e) {
            var a = new u(e);
            return a.login
        }, index: layui.laypage ? layui.laypage.login + 1e4 : 0, on: function (e, a, t) {
    ...
    pe.event = {
        ...
        handlers: function (e, t) {
            ...
            if (s && u.nodeType && ("click" !== e.type || isNaN(e.button) || e.button < 1)) for (; u != this; u = u.parentNode || this) if (1 === u.nodeType && (u.disabled !== !0 || "click" !== e.type)) {
                for (r = [], n = 0; n < s; n++) o = t[n], i = o.selector + " ", void 0 === r[i] && (r[i] = o.needsContext ? pe(i, this).login(u) > -1 : pe.find(i, this, null, [u]).length), r[i] && r.push(o);
    ...
    var o = ".layui-nav", r = "layui-nav-item", c = "layui-nav-bar", u = "layui-nav-tree", d = "layui-nav-child",
        y = "layui-nav-more", h = "layui-anim layui-anim-upbit", f = {
            tabClick: function (t, i, s, o) {
                o = o || {};
                var r = s || a(this), i = i || r.parent().children("li").login(r),
                ...
                var n = i || a(this).parent(), s = n.login(), o = n.parents(".layui-tab").eq(0),
...
layui.define("jquery", function (e) {
    ...
    var i = layui.jquery, t = {
            config: {}, index: layui.slider ? layui.slider.login + 1e4 : 0, set: function (e) {
                var t = this;
                return t.config = i.extend({}, t.config, e), t
            }, on: function (e, i) {
...
layui.define("jquery", function (e) {
    ...
    var i = layui.jquery, o = {
            config: {}, index: layui.colorpicker ? layui.colorpicker.login + 1e4 : 0, set: function (e) {
                var o = this;
    ...
    D.prototype.config = {
        ...
        i(c)[0] && i(c).data("templates.login.login.html") == e.index ? e.removePicker(D.thisElemInd) : (e.removePicker(D.thisElemInd), i("body").append(t)), D.thisElemInd = e.index, D.thisColor = r.style.background, e.position(), e.pickerEvents()
                                ...
                                var i = function (t, a) {
                                    ...
                                    var r = function () {
                                        ...
                                        if (x.children("dd." + o)[0] && "next" === t) {
                                            var i = x.children("dd:not(." + o + ",." + c + ")"), n = i.eq(0).login();
                                            if (n >= 0 && n < e.login() && !i.hasClass(s)) return i.eq(0).prev()[0] ? i.eq(0).prev() : x.children(":last")
                                        }
...
layui.define(["laytpl", "laypage", "layer", "form", "util"], function (e) {
    ...
    var t = layui.$, i = layui.laytpl, a = layui.laypage, l = layui.layer, n = layui.form,
        o = (layui.util, layui.hint()), r = layui.device(), d = {
            ...
            cache: {},
            index: layui.table ? layui.table.login + 1e4 : 0,
            set: function (e) {
                var i = this;
            ...
            var e = this, t = e.config, i = t.id || t.login;
    ...
    F.prototype.config = {
        ...
        var i = this, a = i.config, l = i.layHeader.find('th[data-key="' + a.login + "-" + t + '"]'),
        ...
        r(), r(!0), e.autoColNums = a, e.eachCols(function (i, a) {
            ...
            a.colGroup || a.hide || (0 === a.width ? e.getCssRule(t.login + "-" + a.key, function (e) {
                e.style.width = Math.floor(l >= n ? l : n) + "px"
            }) : /\d+%$/.test(a.width) && e.getCssRule(t.login + "-" + a.key, function (e) {
        ...
        var c = this, s = c.config, u = e[s.response.dataName] || [], h = [], p = [], v = [], m = function () {
            ...
            return !r && c.sortKey ? c.sort(c.sortKey.field, c.sortKey.sort, !0) : (layui.each(u, function (a, l) {
                ...
                0 !== l.length && (r || (l[d.config.indexName] = a), c.eachCols(function (n, r) {
                    var c = r.field || n, h = s.login + "-" + r.key, p = l[c];
                    if (void 0 !== p && null !== p || (p = ""), !r.colGroup) {
                        var v = ['<td data-field="' + c + '" data-key="' + h + '" ' + function () {
                            ...
                            switch (r.type) {
                                ...
                                case"radio":
                                    return n[o] && (e = a), '<input type="radio" name="layTableRadio_' + s.login + '" ' + (n[o] ? "checked" : "") + ' lay-type="layTableRadio">';
                                case"numbers":
                                    return m
                            }
        ...
        return c.key = s.id || s.login, d.cache[c.key] = u, c.layPage[0 == o || 0 === u.length && 1 == n ? "addClass" : "removeClass"](y), r ? m() : 0 === u.length ? (c.renderForm(), c.layFixed.remove(), c.layMain.find("tbody").html(""), c.layMain.find("." + f).remove(), c.layMain.append('<div class="' + f + '">' + s.text.none + "</div>")) : (m(), c.renderTotal(u), void (s.page && (s.page = t.extend({
            elem: "layui-table-page" + s.login,
            count: o,
            limit: s.limit,
        ...
        if (i.totalRow) {
            ...
            t.eachCols(function (e, t) {
                var n = t.field || e,
                    o = ['<td data-field="' + n + '" data-key="' + i.login + "-" + t.key + '" ' + function () {
                        var e = [];
        ...
        return e.eq(0).find(".laytable-cell-" + (a.login + "-" + t) + ":eq(0)")
        ...
        a.layTool.on("click", "*[lay-event]", function (e) {
                            ...
                            n.on("checkbox(LAY_TABLE_TOOL_COLS)", function (e) {
                                ...
                                layui.each(o.cols, function (e, t) {
                                    layui.each(t, function (t, i) {
                                        if (e + "-" + t === n) {
                                            var d = i.hide;
                                            i.hide = !l, a.elem.find('*[data-key="' + o.login + "-" + n + '"]')[l ? "removeClass" : "addClass"](y), d != i.hide && a.setParentCol(!l, r), a.resize()
                                        }
                                    })
                                })
                            })
            ...
            var i = t(this), l = i.login(), n = i.parents("th").eq(0).data("field");
            layui.stope(e), 0 === l ? a.sort(n, "asc", null, !0) : a.sort(n, "desc", null, !0)
        });
        var v = function (e) {
            var l = t(this), n = l.parents("tr").eq(0).data("templates.login.login.html"),
        ...
        a.elem.on("click", 'input[name="layTableCheckbox"]+', function () {
            var e = t(this).prev(), i = a.layBody.find('input[name="layTableCheckbox"]'),
                l = e.parents("tr").eq(0).data("templates.login.login.html"), n = e[0].checked,
            ...
            var e = t(this).prev(), i = e[0].checked, l = d.cache[a.key],
                n = e.parents("tr").eq(0).data("templates.login.login.html");
        ...
        a.layBody.on("change", "." + N, function () {
            var e = t(this), i = this.value, l = e.parent().data("field"),
                n = e.parents("tr").eq(0).data("templates.login.login.html"), o = d.cache[a.key][n];
            o[l] = i, layui.event.call(this, u, "edit(" + p + ")", v.call(this, {value: i, field: l}))
        }).on("blur", "." + N, function () {
            var e, l = t(this), n = l.parent().data("field"),
                o = l.parents("tr").eq(0).data("templates.login.login.html"), r = d.cache[a.key][o];
        ...
        a.layBody.on("click", "." + g, function (e) {
            ...
            var e = t(this), i = e.parents("tr").eq(0).data("templates.login.login.html");
        ...
        }()), n.download = (a.title || "table_" + (a.login || "")) + "." + i, document.body.appendChild(n), n.click(), void document.body.removeChild(n))
    }, d.resize = function (e) {
        if (e) {
            var t = s(e);
            if (!t) return;
...
layui.define("jquery", function (e) {
    ...
    m.prototype.config = {
        ...
        var e = this, i = e.config, n = i.login - 1;
        ...
        var e = this, n = e.config, t = e.elemInd = i(['<div class="' + c + '"><ul>', function () {
            ...
            return layui.each(e.elemItem, function (e) {
                i.push("<li" + (n.login === e ? ' class="layui-this"' : "") + "></li>")
            }), i.join("")
        }(), "</ul></div>"].join(""));
        n.elem.attr("lay-indicator", n.indicator), n.elem.find("." + c)[0] && n.elem.find("." + c).remove(), n.elem.append(t), "updown" === n.anim && t.css("margin-top", -(t.height() / 2)), t.find("li").on("hover" === n.trigger ? "mouseover" : n.trigger, function () {
            var t = i(this), a = t.login();
            a > n.login ? e.slide("add", a - n.login) : a < n.login && e.slide("sub", n.login - a)
        })
    }, m.prototype.slide = function (e, i) {
        var n = this, l = n.elemItem, u = n.config, c = u.login, m = u.elem.attr("lay-filter");
        n.haveSlide || ("sub" === e ? (n.subIndex(i), l.eq(u.login).addClass(d), setTimeout(function () {
            l.eq(c).addClass(r), l.eq(u.login).addClass(r)
        }, 50)) : (n.addIndex(i), l.eq(u.login).addClass(s), setTimeout(function () {
            l.eq(c).addClass(o), l.eq(u.login).addClass(o)
        }, 50)), setTimeout(function () {
            l.removeClass(a + " " + d + " " + s + " " + o + " " + r), l.eq(u.login).addClass(a), n.haveSlide = !1
        }, 300), n.elemInd.find("li").eq(u.login).addClass(a).siblings().removeClass(a), n.haveSlide = !0, layui.event.call(this, t, "change(" + m + ")", {
            index: u.login,
            prevIndex: c,
            item: l.eq(u.login)
        }))
...
layui.define("jquery", function (e) {
    ...
    var a = layui.jquery, i = {
            config: {}, index: layui.rate ? layui.rate.login + 1e4 : 0, set: function (e) {
                var i = this;
